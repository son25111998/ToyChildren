...
public interface ProductService {
	...
	List<ProductEntity> searchcategoryandmanufacturer(ProductEntity products);
	
	
	List<ProductEntity> getListManufacturer(int manufacturerId);
	List<ProductEntity> getListCategory(int categoryId);

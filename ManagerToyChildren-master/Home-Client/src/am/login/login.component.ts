...
import { AuthenticationService } from '../../app/authentication/guard/authentication.service';
import { AlertService } from '../../app/authentication/alert/alert.service';
// import { TranslateService } from '@ngx-translate/core';
import { LanguageItem, LanguageItemList } from '../../app/i18n-setting';
import { User } from '../../app/authentication/guard/user';
...
export class LoginComponent implements OnInit {
  ...
  login() {
    ...
    this.authenticationService.login(this.model.username, this.model.password).subscribe(data=>{
        ...
        localStorage.setItem(Constants.NAME, resp);
